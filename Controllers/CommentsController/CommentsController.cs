...
namespace NovaBlog.Controllers.CommentsController
{
    public class CommentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Comments.Include(c => c.Author).Include(c => c.NovaBlog);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["BlogPostId"] = new SelectList(_context.BlogPosts, "Id", "Contnet");
            return View();
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["BlogPostId"] = new SelectList(_context.BlogPosts, "Id", "Contnet", comment.BlogPostId);
            return View(comment);
        }
